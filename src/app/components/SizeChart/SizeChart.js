      ...
      <div className="bg-white dark:bg-black rounded-lg shadow-lg p-4 md:p-6 w-11/12 sm:w-10/12 md:w-2/3 lg:w-1/2">
        ...
        <div className="overflow-auto">
          <table className="w-full border-collapse border border-gray-300 dark:border-gray-900 text-xs sm:text-sm">
            ...
            <tbody>
              <tr>
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">XS</td>
                ...
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">0-88</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">S</td>
                ...
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">87-90</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">M</td>
                ...
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">90-94</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">L</td>
                ...
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">95-99</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">XL</td>
                ...
                <td className="border border-gray-300 px-2 sm:px-4 py-2 text-center">100-104</td>
              </tr>
            </tbody>
          </table>
        </div>
