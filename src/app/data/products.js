const products = [
  ...
  size: "XS S M L XL",
  category: "Jackets",
  image: "/Jackets/Butter Jacket/1.avif",
  images: [
    "/Jackets/Butter Jacket/2.avif",
    "/Jackets/Butter Jacket/3.avif",
    "/Jackets/Butter Jacket/4.avif",
  ...
  translations: {
    EN: {
      ...
      name: "Butter Jacket",
      description: [
        "A structured jacket made from wool suiting fabric in a delicate butter yellow shade. Its distinctive cut creates a neat silhouette and makes it a versatile foundation for autumn-winter looks.",
        "The clean design and precise construction lines make this a versatile piece for different styling options. The light butter yellow shade softens the look and pairs easily with milky white, beige, chocolate, grey, and black.",
        "The jacket can be worn with the Butter skirt or separately with classic trousers, denim, dresses, and other wardrobe basics.",
        "Fabric: wool suiting fabric.",
        "Season: autumn, winter."
      ],
      colors: ["butter yellow"]
    ...
    FR: {
      ...
      name: "Veste « Butter »",
      description: [
        "Une veste structurée en tissu de laine pour costume, dans une délicate teinte jaune beurre. Sa coupe expressive dessine une silhouette soignée et en fait une pièce à part entière du vestiaire automne-hiver.",
        "Le design épuré et les lignes de construction nettes rendent ce modèle polyvalent et facile à associer. La teinte jaune beurre clair apporte de la douceur à la tenue et s’accorde facilement avec le blanc laiteux, le beige, le chocolat, le gris et le noir.",
        "La veste peut se porter avec la jupe « Butter » ou séparément, avec un pantalon classique, du denim, des robes et d’autres basiques du vestiaire.",
        "Tissu : tissu de laine pour costume.",
        "Saison : automne, hiver."
      ],
      colors: ["jaune beurre"]
    ...
    UA: {
      ...
      name: "Жакет «Butter»",
      description: [
        "Структурний жакет із вовняної костюмної тканини у ніжному масляному відтінку. Виразний крій формує акуратний силует і робить модель самодостатньою основою осінньо-зимових образів.",
        "Лаконічний дизайн і чисті конструктивні лінії роблять модель універсальною для різних стилізацій. Світлий масляний відтінок додає образу м’якості та легко поєднується з молочним, бежевим, шоколадним, сірим і чорним.",
        "Жакет можна носити разом зі спідницею «Butter» або окремо — з класичними брюками, денімом, сукнями та іншими базовими речами.",
        "Тканина: вовняна костюмна тканина.",
        "Сезон: осінь, зима."
      ],
      colors: ["масляний"]
    ...
    RU: {
      ...
      name: "Жакет «Butter»",
      description: [
        "Структурный жакет из шерстяной костюмной ткани в нежном масляном оттенке. Выразительный крой формирует аккуратный силуэт и делает модель самодостаточной основой осенне-зимних образов.",
        "Лаконичный дизайн и чистые конструктивные линии делают модель универсальной для разных стилизаций. Светлый масляный оттенок добавляет образу мягкости и легко сочетается с молочным, бежевым, шоколадным, серым и чёрным.",
        "Жакет можно носить вместе с юбкой «Butter» или отдельно — с классическими брюками, денимом, платьями и другими базовыми вещами.",
        "Ткань: шерстяная костюмная ткань.",
        "Сезон: осень, зима."
      ],
      colors: ["масляный"]
  ...
  size: "XS S M L XL",
  category: "Costumes",
  image: "/Costumes/Butter Suit/1.avif",
  images: [
    "/Costumes/Butter Suit/2.avif",
    "/Costumes/Butter Suit/3.avif",
    "/Costumes/Butter Suit/4.avif",
    "/Costumes/Butter Suit/5.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Butter Suit",
      description: [
        "A feminine suit made from wool suiting fabric in a soft butter yellow shade. The clean cut and light, warm palette create an elegant look for an autumn-winter wardrobe.",
        "The set consists of a jacket and a skirt in the same butter yellow shade. The structured top creates a distinctive silhouette, while the clean-cut skirt balances the look and adds understated femininity.",
        "The suit adapts easily to different styling options: worn together, the pieces create a cohesive monochrome look, while the jacket and skirt can be worn separately with basic knitwear, shirts, trousers, or denim.",
        "Fabric: wool suiting fabric.",
        "Season: autumn, winter."
      ],
      colors: ["butter yellow"]
    ...
    FR: {
      ...
      name: "Costume « Butter »",
      description: [
        "Un costume féminin en tissu de laine pour costume, dans une douce teinte jaune beurre. La coupe épurée et la palette claire et chaleureuse créent une allure élégante pour le vestiaire automne-hiver.",
        "L’ensemble se compose d’une veste et d’une jupe dans la même teinte jaune beurre. Le haut structuré dessine une silhouette expressive, tandis que la jupe épurée équilibre la tenue et lui apporte une féminité discrète.",
        "Le costume se prête facilement à différentes associations : porté en ensemble, il crée une tenue monochrome harmonieuse, tandis que la veste et la jupe peuvent se porter séparément avec des mailles basiques, des chemises, des pantalons ou du denim.",
        "Tissu : tissu de laine pour costume.",
        "Saison : automne, hiver."
      ],
      colors: ["jaune beurre"]
    ...
    UA: {
      ...
      name: "Костюм «Butter»",
      description: [
        "Жіночний костюм із вовняної костюмної тканини у м’якому масляному відтінку. Лаконічний крій та світла тепла палітра створюють елегантний образ для осінньо-зимового гардероба.",
        "Комплект складається з жакета та спідниці, витриманих в одному масляному відтінку. Структурний верх формує виразний силует, а лаконічний низ урівноважує образ і додає йому стриманої жіночності.",
        "Костюм легко адаптується під різні стилізації: у комплекті створює цілісний монохромний образ, а жакет і спідницю можна носити окремо з базовим трикотажем, сорочками, брюками або денімом.",
        "Тканина: вовняна костюмна тканина.",
        "Сезон: осінь, зима."
      ],
      colors: ["масляний"]
    ...
    RU: {
      ...
      name: "Костюм «Butter»",
      description: [
        "Женственный костюм из шерстяной костюмной ткани в мягком масляном оттенке. Лаконичный крой и светлая тёплая палитра создают элегантный образ для осенне-зимнего гардероба.",
        "Комплект состоит из жакета и юбки, выдержанных в одном масляном оттенке. Структурный верх формирует выразительный силуэт, а лаконичный низ уравновешивает образ и добавляет ему сдержанной женственности.",
        "Костюм легко адаптируется под разные стилизации: в комплекте создаёт цельный монохромный образ, а жакет и юбку можно носить отдельно с базовым трикотажем, рубашками, брюками или денимом.",
        "Ткань: шерстяная костюмная ткань.",
        "Сезон: осень, зима."
      ],
      colors: ["масляный"]
  ...
  size: "XS S M L XL",
  category: "Jackets",
  image: "/Jackets/Nevada Jacket/1.avif",
  images: [
    "/Jackets/Nevada Jacket/2.avif",
    "/Jackets/Nevada Jacket/3.avif",
    "/Jackets/Nevada Jacket/4.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Nevada Jacket",
      description: [
        "A fitted jacket with a defined shoulder line and a deep V-neckline. The clean design without lapels creates a modern silhouette, while the double-breasted fastening emphasizes the waist.",
        "The lapel-free design features a deep V-neckline, defined shoulders, and a double-breasted fastening with two buttons. Vertical darts shape the fit to the figure, while flap pockets add a classic touch.",
        "The longer length balances the fitted silhouette and allows the jacket to be worn with the Nevada trousers as a set or separately with denim, skirts, or classic trousers.",
    ...
    FR: {
      ...
      name: "Veste « Nevada »",
      description: [
        "Une veste cintrée à la ligne d’épaules marquée et au profond décolleté en V. Le design épuré sans revers crée une silhouette nette et moderne, tandis que la fermeture croisée souligne la taille.",
        "Le modèle sans revers présente un profond décolleté en V, une ligne d’épaules marquée et une fermeture croisée à deux boutons. Les pinces verticales ajustent la coupe à la silhouette, tandis que les poches à rabat apportent une touche classique.",
        "La longueur allongée équilibre la silhouette cintrée et permet de porter la veste en ensemble avec le pantalon « Nevada » ou séparément avec du denim, des jupes ou un pantalon classique.",
    ...
    UA: {
      ...
      name: "Жакет «Nevada»",
      description: [
        "Приталений жакет із виразною лінією плечей і глибоким V-подібним вирізом. Лаконічний дизайн без лацканів робить силует чистим і сучасним, а двобортна застібка підкреслює лінію талії.",
        "Модель без лацканів доповнена глибоким V-подібним вирізом, акцентованою лінією плечей і двобортною застібкою на два ґудзики. Вертикальні виточки формують посадку по фігурі, а кишені з клапанами додають класичний штрих.",
        "Подовжена довжина врівноважує приталений силует і дозволяє носити жакет як у комплекті з брюками «Nevada», так і окремо з денімом, спідницями або класичними брюками.",
    ...
    RU: {
      ...
      name: "Жакет «Nevada»",
      description: [
        "Приталенный жакет с выразительной линией плеч и глубоким V-образным вырезом. Лаконичный дизайн без лацканов делает силуэт чистым и современным, а двубортная застёжка подчёркивает линию талии.",
        "Модель без лацканов дополнена глубоким V-образным вырезом, акцентированной линией плеч и двубортной застёжкой на две пуговицы. Вертикальные вытачки формируют посадку по фигуре, а карманы с клапанами добавляют классический штрих.",
        "Удлинённая длина уравновешивает приталенный силуэт и позволяет носить жакет как в комплекте с брюками «Nevada», так и отдельно с денимом, юбками или классическими брюками.",
  ...
  size: "XS S M L XL",
  category: "Pants",
  image: "/Pants/Nevada Pants/1.avif",
  images: [
    "/Pants/Nevada Pants/2.avif",
    "/Pants/Nevada Pants/3.avif",
    "/Pants/Nevada Pants/4.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Nevada Pants",
      description: [
        "Wide-leg trousers with a high waist and statement cuffs at the hem. The relaxed silhouette creates beautiful volume, while the unusual button-fastened detail gives the design a distinctive look.",
        "The high waist visually emphasizes the waistline, while the wide legs drape freely over the figure. The main accent is the wide cuffs at the hem, secured with buttons, which give classic trousers an unconventional shape.",
        "The design looks striking with the Nevada jacket and also pairs easily with simple tops, shirts, knitwear, and basic jackets.",
        "Fabric: suiting fabric.",
        "Season: autumn, winter, spring."
      ],
      colors: ["cornflower blue"]
    ...
    FR: {
      category: "Pantalons",
      name: "Pantalon « Nevada »",
      description: [
        "Un pantalon large à taille haute avec des revers marqués au bas des jambes. La silhouette ample crée un beau volume, tandis que le détail original fermé par un bouton rend le modèle reconnaissable.",
        "La taille haute souligne visuellement la taille, tandis que les jambes larges tombent librement sur la silhouette. L’accent principal réside dans les larges revers en bas, maintenus par des boutons, qui donnent une forme inhabituelle à ce pantalon classique.",
        "Le modèle se distingue avec la veste « Nevada » et s’associe aussi facilement à des hauts épurés, des chemises, des mailles et des vestes basiques.",
        "Tissu : tissu pour costume.",
        "Saison : automne, hiver, printemps."
      ],
      colors: ["bleu bleuet"]
    ...
    UA: {
      ...
      name: "Брюки «Nevada»",
      description: [
        "Широкі брюки з високою посадкою та акцентними манжетами внизу. Вільний силует створює красивий об’єм, а незвична деталь із застібкою на ґудзик робить модель впізнаваною.",
        "Висока посадка візуально підкреслює талію, а широкі штанини вільно спадають по фігурі. Головний акцент — широкі манжети по низу, зафіксовані ґудзиками, які додають класичним брюкам нестандартної форми.",
        "Модель ефектно виглядає з жакетом «Nevada», а також легко поєднується з лаконічними топами, сорочками, трикотажем і базовими жакетами.",
        "Тканина: костюмна тканина.",
        "Сезон: осінь, зима, весна."
      ],
      colors: ["васильковий"]
    ...
    RU: {
      ...
      name: "Брюки «Nevada»",
      description: [
        "Широкие брюки с высокой посадкой и акцентными манжетами внизу. Свободный силуэт создаёт красивый объём, а необычная деталь с застёжкой на пуговицу делает модель узнаваемой.",
        "Высокая посадка визуально подчёркивает талию, а широкие штанины свободно спадают по фигуре. Главный акцент — широкие манжеты по низу, зафиксированные пуговицами, которые добавляют классическим брюкам нестандартной формы.",
        "Модель эффектно выглядит с жакетом «Nevada», а также легко сочетается с лаконичными топами, рубашками, трикотажем и базовыми жакетами.",
        "Ткань: костюмная ткань.",
        "Сезон: осень, зима, весна."
      ],
      colors: ["васильковый"]
  ...
  size: "XS S M L XL",
  category: "Costumes",
  image: "/Costumes/Nevada Suit/1.avif",
  images: [
    "/Costumes/Nevada Suit/2.avif",
    "/Costumes/Nevada Suit/3.avif",
    "/Costumes/Nevada Suit/4.avif",
    "/Costumes/Nevada Suit/5.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Nevada Suit",
      description: [
        "An elegant suit in a cornflower blue shade with an emphasis on a defined silhouette and modern proportions. A fitted jacket with a deep V-neckline pairs with wide-leg trousers to create a striking look in a contemporary classic style.",
        "The fitted jacket features a deep V-neckline without lapels, a double-breasted button fastening, and flap pockets. Defined shoulders and darts emphasize the silhouette and create a structured fit.",
        "High-waisted wide-leg trousers create soft volume throughout their length. A distinctive detail is the wide cuffs at the hem with a button fastening, which give the classic cut extra character.",
        "The suit can be worn as a complete look, or the jacket and trousers can be styled separately.",
        "Fabric: suiting fabric.",
        "Season: autumn, winter, spring."
      ],
      colors: ["cornflower blue"]
    ...
    FR: {
      ...
      name: "Costume « Nevada »",
      description: [
        "Un élégant costume dans une teinte bleu bleuet qui met en valeur une silhouette nette et des proportions modernes. Une veste cintrée à profond décolleté en V s’associe à un pantalon large pour créer une allure expressive dans un style classique contemporain.",
        "La veste cintrée présente un profond décolleté en V sans revers, une fermeture croisée à boutons et des poches à rabat. La ligne d’épaules marquée et les pinces soulignent la silhouette et dessinent une coupe structurée.",
        "Le pantalon large à taille haute crée un volume souple sur toute la longueur. Les larges revers au bas des jambes, fermés par un bouton, constituent un détail distinctif qui donne davantage de caractère à cette coupe classique.",
        "Le costume peut se porter en ensemble, ou la veste et le pantalon peuvent être associés séparément à d’autres pièces.",
        "Tissu : tissu pour costume.",
        "Saison : automne, hiver, printemps."
      ],
      colors: ["bleu bleuet"]
    ...
    UA: {
      ...
      name: "Костюм «Nevada»",
      description: [
        "Елегантний костюм у васильковому відтінку з акцентом на чіткий силует і сучасні пропорції. Приталений жакет із глибоким V-вирізом поєднується з широкими брюками, створюючи виразний образ у стилі сучасної класики.",
        "Жакет приталеного силуету має глибокий V-подібний виріз без лацканів, двобортну застібку на ґудзики та кишені з клапанами. Акцентована лінія плечей і виточки підкреслюють силует та формують чітку посадку.",
        "Широкі брюки з високою посадкою створюють м’який об’єм по всій довжині. Особлива деталь моделі — широкі манжети внизу з застібкою на ґудзик, завдяки яким класичний крій отримує більш характерне звучання.",
        "Костюм можна носити як цілісний образ або стилізувати жакет і брюки окремо.",
        "Тканина: костюмна тканина.",
        "Сезон: осінь, зима, весна."
      ],
      colors: ["васильковий"]
    ...
    RU: {
      ...
      name: "Костюм «Nevada»",
      description: [
        "Элегантный костюм в васильковом оттенке с акцентом на чёткий силуэт и современные пропорции. Приталенный жакет с глубоким V-вырезом сочетается с широкими брюками, создавая выразительный образ в стиле современной классики.",
        "Жакет приталенного силуэта имеет глубокий V-образный вырез без лацканов, двубортную застёжку на пуговицы и карманы с клапанами. Акцентированная линия плеч и вытачки подчёркивают силуэт и формируют чёткую посадку.",
        "Широкие брюки с высокой посадкой создают мягкий объём по всей длине. Особая деталь модели — широкие манжеты внизу с застёжкой на пуговицу, благодаря которым классический крой получает более характерное звучание.",
        "Костюм можно носить как цельный образ или стилизовать жакет и брюки отдельно.",
        "Ткань: костюмная ткань.",
        "Сезон: осень, зима, весна."
      ],
      colors: ["васильковый"]
  ...
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Navy Blue Dress/1.avif",
  images: [
    "/Dress/Navy Blue Dress/2.avif",
    "/Dress/Navy Blue Dress/3.avif",
    "/Dress/Navy Blue Dress/4.avif",
    "/Dress/Navy Blue Dress/5.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      description: [
        "An elegant wrap maxi dress with distinctive contrasting trim and an accentuated waist. A deep navy blue shade combined with soft viscose creates a light, feminine silhouette.",
        "The wrap bodice features a deep V-neckline that visually elongates the silhouette. Soft, voluminous sleeves with cuffs add an airy feel, while a statement belt emphasizes the waist and allows the fit to be adjusted.",
        "Contrasting trim in a warm brown shade follows the wrap line and continues down the skirt. Decorative buttons complete the design and complement its clean geometry.",
        "The maxi length and flowing skirt create a fluid silhouette in motion. The dress is easy to style with boots for everyday looks or for more elegant occasions.",
        "Fabric: viscose.",
        "Season: autumn, winter, spring."
      ],
      colors: ["navy blue"]
    ...
    FR: {
      ...
      name: "Robe « Navy blue »",
      description: [
        "Une élégante robe longue portefeuille aux finitions contrastantes expressives et à la taille soulignée. La nuance bleu marine profond associée à une viscose douce crée une silhouette légère et féminine.",
        "Le haut croisé présente un profond décolleté en V qui allonge visuellement la silhouette. Les manches souples et volumineuses à poignets apportent de la légèreté, tandis qu’une ceinture marquée souligne la taille et permet d’ajuster la coupe.",
        "Une finition contrastante dans une nuance de brun chaud suit la ligne croisée et se prolonge sur la jupe. Des boutons décoratifs complètent le modèle et en soulignent la géométrie épurée.",
        "La longueur maxi et la jupe ample créent une silhouette fluide en mouvement. La robe se porte facilement avec des bottes au quotidien ou pour des occasions plus élégantes.",
        "Tissu : viscose.",
        "Saison : automne, hiver, printemps."
      ],
      colors: ["bleu marine"]
    ...
    UA: {
      category: "Сукні",
      name: "Сукня «Navy blue»",
      description: [
        "Елегантна сукня максі на запах із виразним контрастним оздобленням та акцентом на талії. Глибокий темно-синій відтінок у поєднанні з м’якою віскозою створює легкий, жіночний силует.",
        "Верх виконаний на запах із глибоким V-подібним вирізом, який візуально витягує силует. М’які об’ємні рукави з манжетами додають образу легкості, а акцентний пояс підкреслює талію та дозволяє регулювати посадку.",
        "Контрастне оздоблення теплого коричневого відтінку проходить уздовж лінії запаху та продовжується по спідниці. Декоративні ґудзики доповнюють дизайн і підтримують лаконічну геометрію моделі.",
        "Довжина максі та вільна спідниця створюють плавний силует у русі. Сукня легко стилізується як для повсякденних образів із чоботами, так і для більш елегантних виходів.",
        "Тканина: віскоза.",
        "Сезон: осінь, зима, весна."
      ],
      colors: ["темно-синій"]
    ...
    RU: {
      category: "Платья",
      name: "Платье «Navy blue»",
      description: [
        "Элегантное платье макси на запах с выразительной контрастной отделкой и акцентом на талии. Глубокий тёмно-синий оттенок в сочетании с мягкой вискозой создаёт лёгкий, женственный силуэт.",
        "Верх выполнен на запах с глубоким V-образным вырезом, который визуально вытягивает силуэт. Мягкие объёмные рукава с манжетами добавляют образу лёгкости, а акцентный пояс подчёркивает талию и позволяет регулировать посадку.",
        "Контрастная отделка тёплого коричневого оттенка проходит вдоль линии запаха и продолжается по юбке. Декоративные пуговицы дополняют дизайн и поддерживают лаконичную геометрию модели.",
        "Длина макси и свободная юбка создают плавный силуэт в движении. Платье легко стилизуется как для повседневных образов с сапогами, так и для более элегантных выходов.",
        "Ткань: вискоза.",
        "Сезон: осень, зима, весна."
      ],
      colors: ["тёмно-синий"]
  ...
  size: "XS S M L XL",
  category: "Skirts",
  image: "/Skirts/Creamy Skirt/1.avif",
  images: [
    "/Skirts/Creamy Skirt/2.avif",
    "/Skirts/Creamy Skirt/3.avif",
  ...
  translations: {
    EN: {
      ...
      name: "Creamy Skirt",
      description: [
        "A clean-cut wool midi skirt in a cream shade. The high waist and straight silhouette create a clean, elongated line and make this a versatile piece for classic and everyday looks.",
        "The design features a high waist, a neat waistband, and a straight midi silhouette that gently follows the lines of the figure.",
        "The minimalist design without excess decoration highlights the quality of the fabric, the fit, and the delicate cream shade. The skirt forms a coordinated set with the Creamy jacket, yet also works easily as a standalone wardrobe staple with sweaters, turtlenecks, shirts, and other jackets.",
        "Fabric: 75% natural wool.",
        "Season: autumn, winter."
      ],
      colors: ["cream"]
    ...
    FR: {
      ...
      name: "Jupe « Creamy »",
      description: [
        "Une jupe midi épurée en laine dans une teinte crème. La taille haute et la coupe droite dessinent une ligne nette et élancée, faisant de ce modèle une pièce polyvalente pour les tenues classiques et quotidiennes.",
        "Le modèle présente une taille haute, une ceinture soignée et une coupe droite de longueur midi qui suit délicatement les lignes de la silhouette.",
        "Le design minimaliste, sans décoration superflue, met en valeur la qualité du tissu, la coupe et la délicate teinte crème. La jupe forme un ensemble harmonieux avec la veste « Creamy », mais se porte aussi facilement seule comme une base du vestiaire, avec des pulls, des cols roulés, des chemises et d’autres vestes.",
        "Tissu : 75 % de laine naturelle.",
        "Saison : automne, hiver."
      ],
      colors: ["crème"]
    ...
    UA: {
      category: "Спідниці",
      name: "Спідниця «Creamy»",
      description: [
        "Лаконічна вовняна спідниця міді у вершковому відтінку. Висока посадка та прямий силует створюють чисту витягнуту лінію й роблять модель універсальною для класичних і повсякденних образів.",
        "Модель має високу посадку, акуратний пояс і прямий силует довжини міді, який м’яко повторює лінії фігури.",
        "Мінімалістичний дизайн без зайвого декору дозволяє зробити акцент на якості тканини, посадці та ніжному вершковому відтінку. Спідниця створює цілісний комплект із жакетом «Creamy», але легко працює і як самостійна база — зі светрами, гольфами, сорочками та іншими жакетами.",
        "Тканина: 75% натуральна вовна.",
        "Сезон: осінь, зима."
      ],
      colors: ["вершковий"]
    ...
    RU: {
      ...
      name: "Юбка «Creamy»",
      description: [
        "Лаконичная шерстяная юбка миди в сливочном оттенке. Высокая посадка и прямой силуэт создают чистую вытянутую линию и делают модель универсальной для классических и повседневных образов.",
        "Модель имеет высокую посадку, аккуратный пояс и прямой силуэт длины миди, который мягко повторяет линии фигуры.",
        "Минималистичный дизайн без лишнего декора позволяет сделать акцент на качестве ткани, посадке и нежном сливочном оттенке. Юбка создаёт цельный комплект с жакетом «Creamy», но легко работает и как самостоятельная база — со свитерами, водолазками, рубашками и другими жакетами.",
        "Ткань: 75% натуральная шерсть.",
        "Сезон: осень, зима."
      ],
      colors: ["сливочный"]
  ...
  size: "XS S M L XL",
  category: "Jackets",
  image: "/Jackets/Creamy Jacket/1.avif",
  images: [
    "/Jackets/Creamy Jacket/2.avif",
    "/Jackets/Creamy Jacket/3.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Creamy Jacket",
      description: [
        "A fitted wool jacket in a cream shade with an emphasis on the waist. Defined shoulders, a turn-down collar, and decorative details create a structured, feminine silhouette.",
        "The carefully designed fitted cut emphasizes the waist while maintaining the clearly defined structure of the silhouette.",
        "The design features a turn-down collar, three-quarter sleeves with wide cuffs, and fabric-covered button fastening. A wide horizontal detail at the waist and decorative flaps create distinctive geometry and make the jacket a statement piece in its own right.",
        "Wear it with the Creamy skirt or separately with classic trousers, denim, or a contrasting skirt.",
        "Fabric: 75% natural wool.",
        "Season: autumn, winter."
      ],
      colors: ["cream"]
    ...
    FR: {
      ...
      name: "Veste « Creamy »",
      description: [
        "Une veste cintrée en laine dans une teinte crème qui souligne la taille. Des épaules marquées, un col rabattu et des détails décoratifs dessinent une silhouette structurée et féminine.",
        "La coupe cintrée soigneusement étudiée met la taille en valeur tout en préservant une silhouette nettement structurée.",
        "Le modèle présente un col rabattu, des manches trois-quarts à larges poignets et une fermeture à boutons recouverts de tissu. Un large détail horizontal à la taille et des rabats décoratifs créent une géométrie expressive et font de la veste une pièce forte à elle seule.",
        "Elle se porte avec la jupe « Creamy » ou séparément, avec un pantalon classique, du denim ou une jupe contrastante.",
        "Tissu : 75 % de laine naturelle.",
        "Saison : automne, hiver."
      ],
      colors: ["crème"]
    ...
    UA: {
      ...
      name: "Жакет «Creamy»",
      description: [
        "Приталений вовняний жакет у вершковому відтінку з акцентом на лінії талії. Чіткі плечі, відкладний комір і декоративні деталі формують структурний, жіночний силует.",
        "Продуманий приталений крій підкреслює талію, зберігаючи чітку архітектуру силуету.",
        "Модель доповнена відкладним коміром, рукавами 3/4 із широкими манжетами та застібкою на обтягнуті тканиною ґудзики. Широка горизонтальна деталь на талії та декоративні клапани створюють виразну геометрію й роблять жакет самодостатнім елементом образу.",
        "Можна носити як разом зі спідницею «Creamy», так і окремо — з класичними брюками, денімом або контрастною спідницею.",
        "Тканина: 75% натуральна вовна.",
        "Сезон: осінь, зима."
      ],
      colors: ["вершковий"]
    ...
    RU: {
      ...
      name: "Жакет «Creamy»",
      description: [
        "Приталенный шерстяной жакет в сливочном оттенке с акцентом на линии талии. Чёткие плечи, отложной воротник и декоративные детали формируют структурный, женственный силуэт.",
        "Продуманный приталенный крой подчёркивает талию, сохраняя чёткую архитектуру силуэта.",
        "Модель дополнена отложным воротником, рукавами 3/4 с широкими манжетами и застёжкой на обтянутые тканью пуговицы. Широкая горизонтальная деталь на талии и декоративные клапаны создают выразительную геометрию и делают жакет самодостаточным элементом образа.",
        "Можно носить как вместе с юбкой «Creamy», так и отдельно — с классическими брюками, денимом или контрастной юбкой.",
        "Ткань: 75% натуральная шерсть.",
        "Сезон: осень, зима."
      ],
      colors: ["сливочный"]
  ...
  size: "XS S M L XL",
  category: "Costumes",
  image: "/Costumes/Creamy Suit/1.avif",
  images: [
    "/Costumes/Creamy Suit/2.avif",
    "/Costumes/Creamy Suit/3.avif",
    "/Costumes/Creamy Suit/4.avif",
    "/Costumes/Creamy Suit/5.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Creamy Suit",
      description: [
        "An elegant suit containing natural wool in a delicate cream shade. A fitted jacket with a defined waist and a midi skirt create a refined feminine silhouette in a modern interpretation of classic tailoring.",
        "The set consists of a fitted jacket and a clean-cut midi skirt. The jacket features a structured shoulder line, a turn-down collar, three-quarter sleeves with wide cuffs, and distinctive shaping at the waist. Fabric-covered buttons and decorative flaps emphasize the crisp lines of the cut.",
        "The straight skirt balances the more intricate jacket and visually elongates the silhouette. The cream shade makes the suit a soft alternative to classic dark sets and pairs easily with milky white, beige, chocolate, and contrasting accessories.",
        "Fabric: 75% natural wool.",
        "Season: autumn, winter."
      ],
      colors: ["cream"]
    ...
    FR: {
      ...
      name: "Costume « Creamy »",
      description: [
        "Un élégant costume contenant de la laine naturelle dans une délicate teinte crème. Une veste cintrée à la taille marquée et une jupe midi dessinent une silhouette féminine raffinée, dans une interprétation contemporaine du style classique.",
        "L’ensemble se compose d’une veste cintrée et d’une jupe midi épurée. La veste présente une ligne d’épaules structurée, un col rabattu, des manches trois-quarts à larges poignets et une construction soulignant la taille. Les boutons recouverts de tissu et les rabats décoratifs accentuent les lignes graphiques de la coupe.",
        "La jupe droite équilibre la coupe plus travaillée de la veste et allonge visuellement la silhouette. La teinte crème offre une alternative douce aux ensembles sombres classiques et s’associe facilement à des accessoires blanc laiteux, beiges, chocolat ou contrastants.",
        "Tissu : 75 % de laine naturelle.",
        "Saison : automne, hiver."
      ],
      colors: ["crème"]
    ...
    UA: {
      ...
      name: "Костюм «Creamy»",
      description: [
        "Елегантний костюм із натуральною вовною у ніжному вершковому відтінку. Приталений жакет із виразною лінією талії та спідниця міді створюють витончений жіночний силует у сучасній інтерпретації класики.",
        "Комплект складається з приталеного жакета та лаконічної спідниці довжини міді. Жакет має чітко сформовану лінію плечей, відкладний комір, рукав 3/4 з широкими манжетами та акцентну конструкцію в зоні талії. Застібка на обтягнуті тканиною ґудзики й декоративні клапани підкреслюють графічність крою.",
        "Пряма спідниця врівноважує складніший крій жакета та візуально витягує силует. Вершковий відтінок робить костюм м’якою альтернативою класичним темним комплектам і легко поєднується з молочними, бежевими, шоколадними та контрастними аксесуарами.",
        "Тканина: 75% натуральна вовна.",
        "Сезон: осінь, зима."
      ],
      colors: ["вершковий"]
    ...
    RU: {
      ...
      name: "Костюм «Creamy»",
      description: [
        "Элегантный костюм с натуральной шерстью в нежном сливочном оттенке. Приталенный жакет с выразительной линией талии и юбка миди создают утончённый женственный силуэт в современной интерпретации классики.",
        "Комплект состоит из приталенного жакета и лаконичной юбки длины миди. Жакет имеет чётко сформированную линию плеч, отложной воротник, рукав 3/4 с широкими манжетами и акцентную конструкцию в зоне талии. Застёжка на обтянутые тканью пуговицы и декоративные клапаны подчёркивают графичность кроя.",
        "Прямая юбка уравновешивает более сложный крой жакета и визуально вытягивает силуэт. Сливочный оттенок делает костюм мягкой альтернативой классическим тёмным комплектам и легко сочетается с молочными, бежевыми, шоколадными и контрастными аксессуарами.",
        "Ткань: 75% натуральная шерсть.",
        "Сезон: осень, зима."
      ],
      colors: ["сливочный"]
...
sku: "99446",
  ...
  translations: {
    EN: {
      ...
      name: "Écru Top",
      description: [
        "The «Écru» top is a clean hemp muslin model in a natural beige shade.",
    ...
    FR: {
      ...
      name: "Top ««Écru»»",
      description: [
        "Le top « «Écru» » est un modèle épuré en mousseline de chanvre dans une teinte beige naturelle.",
    ...
    UA: {
      ...
      name: "Топ ««Écru»»",
      description: [
        "Топ ««Écru»» — лаконічна модель із конопляного мусліну в натуральному бежевому відтінку.",
    ...
    RU: {
      ...
      name: "Топ «Écru»",
      description: [
        "Топ «Écru» — лаконичная модель из конопляного муслина в натуральном бежевом оттенке.",
...
sku: "99445",
  size: "XS S M L XL",
  category: "Skirts",
  image: "/Skirts/Écru Skirt/1.avif",
  images: [
    "/Skirts/Écru Skirt/2.avif",
    "/Skirts/Écru Skirt/3.avif",
    "/Skirts/Écru Skirt/4.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "«Écru» Skirt",
      description: [
        "The «Écru» skirt is a light hemp muslin model in a natural beige shade.",
    ...
    FR: {
      ...
      name: "Jupe «Écru»",
      description: [
        "La jupe «Écru» est un modèle léger en mousseline de chanvre dans une teinte beige naturelle.",
    ...
    UA: {
      ...
      name: "Спідниця «Écru»",
      description: [
        "Спідниця «Écru» — легка модель із конопляного мусліну у природному бежевому відтінку.",
    ...
    RU: {
      ...
      name: "Юбка «Écru»",
      description: [
        "Юбка «Écru» — лёгкая модель из конопляного муслина в натуральном бежевом оттенке.",
...
sku: "99444",
  size: "XS S M L XL",
  category: "Costumes",
  image: "/Costumes/Écru Suit/1.avif",
  images: [
    "/Costumes/Écru Suit/2.avif",
    "/Costumes/Écru Suit/3.avif",
    "/Costumes/Écru Suit/4.avif",
    "/Costumes/Écru Suit/5.avif",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
...
sku: "99441",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Iris Dress/1.webp",
  images: [
    "/Dress/Iris Dress/2.webp",
    "/Dress/Iris Dress/3.webp",
    "/Dress/Iris Dress/4.webp",
    "/Dress/Iris Dress/5.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Iris Dress",
      description: [
        "The Iris dress is a light and airy model made from natural two-layer muslin in a delicate blue shade.",
        "The relaxed silhouette, tiered hem, and delicate lace create a romantic look with a feeling of summer freedom.",
        "The model features a relaxed straight silhouette that does not restrict movement and provides maximum comfort.",
        "The tiered hem with contrasting inserts and delicate lace adds a gentle romantic mood and draws attention to the details.",
        "The minimalist cut makes the dress easy to style for vacations, travel, and city summer looks with natural accessories and footwear.",
        "Fabric: natural two-layer muslin.",
        "Season: spring, summer."
      ],
      colors: ["light blue"]
    },
    FR: {
      ...
      name: "Robe Iris",
      description: [
        "La robe Iris est un modèle léger et aérien en mousseline naturelle double couche dans une délicate nuance bleu clair.",
        "La silhouette ample, le bas à étages et la dentelle délicate créent une allure romantique avec une sensation de liberté estivale.",
        "Le modèle présente une coupe droite ample qui ne limite pas les mouvements et offre un confort maximal.",
        "Le bas à étages avec des empiècements contrastés et une dentelle délicate apporte une douce note romantique et met l’accent sur les détails.",
        "La coupe minimaliste permet de styliser facilement la robe pour les vacances, les voyages et les looks d’été en ville avec des accessoires et chaussures naturels.",
        "Tissu : mousseline naturelle double couche.",
        "Saison : printemps, été."
      ],
      colors: ["bleu clair"]
    },
    UA: {
      ...
      name: "Сукня «Iris»",
      description: [
        "Сукня «Iris» — легка та повітряна модель із натурального двошарового мусліну у ніжному блакитному відтінку.",
        "Вільний силует, багатоярусний низ та делікатне мереживо створюють романтичний образ із відчуттям літньої свободи.",
        "Модель має вільний прямий силует, який не сковує рухів та створює максимально комфортну посадку.",
        "Багатоярусний низ із контрастними вставками та делікатним мереживом додає сукні ніжного романтичного настрою та акцентує увагу на деталях.",
        "Мінімалістичний крій дозволяє легко стилізувати модель як для відпочинку та подорожей, так і для міських літніх образів у поєднанні з натуральними аксесуарами та взуттям.",
        "Тканина: натуральний двошаровий муслін.",
        "Сезон: весна, літо."
      ],
      colors: ["блакитний"]
    },
    RU: {
      ...
      name: "Платье «Iris»",
      description: [
        "Платье «Iris» — легкая и воздушная модель из натурального двухслойного муслина в нежном голубом оттенке.",
        "Свободный силуэт, многоярусный низ и деликатное кружево создают романтичный образ с ощущением летней свободы.",
        "Модель имеет свободный прямой силуэт, который не сковывает движений и обеспечивает максимально комфортную посадку.",
        "Многоярусный низ с контрастными вставками и деликатным кружевом добавляет платью нежного романтичного настроения и акцентирует внимание на деталях.",
        "Минималистичный крой позволяет легко стилизовать модель для отдыха, путешествий и городских летних образов в сочетании с натуральными аксессуарами и обувью.",
        "Ткань: натуральный двухслойный муслин.",
        "Сезон: весна, лето."
      ],
      colors: ["голубой"]
    }
...
sku: "99440",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Bella Dress/1.webp",
  images: [
    "/Dress/Bella Dress/2.webp",
    "/Dress/Bella Dress/3.webp",
    "/Dress/Bella Dress/4.webp",
    "/Dress/Bella Dress/5.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Bella Dress",
      description: [
        "The Bella dress is an elegant model made from natural proshva, created for light and feminine summer looks.",
        "Its laconic silhouette, delicate fabric texture, and soft fit make it versatile for the city, vacations, and special moments.",
        "The model features a neat fitted top with a square neckline that beautifully highlights the shoulders and neck.",
        "The relaxed skirt moves softly as you walk, creating a light and romantic silhouette.",
        "Thanks to its minimalist design, the dress is easy to style in casual looks and more feminine summer combinations.",
        "The dress is perfect for walks, vacations, travel, and warm evenings when you want to combine comfort and refinement.",
        "Fabric: natural proshva.",
        "Season: spring, summer."
      ],
      colors: ["beige"]
    },
    FR: {
      ...
      name: "Robe Bella",
      description: [
        "La robe Bella est un modèle raffiné en broderie anglaise naturelle, créé pour des looks d’été légers et féminins.",
        "Sa silhouette laconique, la texture délicate du tissu et sa coupe douce la rendent polyvalente pour la ville, les vacances et les moments particuliers.",
        "Le modèle présente un haut ajusté soigné avec une encolure carrée qui souligne joliment la ligne des épaules et du cou.",
        "La jupe ample bouge doucement à chaque pas, créant une silhouette légère et romantique.",
        "Grâce à son design minimaliste, la robe se stylise facilement dans des looks casual comme dans des associations estivales plus féminines.",
        "Elle est idéale pour les promenades, les vacances, les voyages et les soirées chaudes où l’on veut associer confort et raffinement.",
        "Tissu : broderie anglaise naturelle.",
        "Saison : printemps, été."
      ],
      colors: ["beige"]
    },
    UA: {
      ...
      name: "Сукня «Bella»",
      description: [
        "Сукня «Bella» — витончена модель із натуральної прошви, створена для легких та жіночних літніх образів.",
        "Лаконічний силует, делікатна фактура тканини та м’яка посадка роблять її універсальною для міста, відпочинку чи особливих моментів.",
        "Модель має акуратний приталений верх із квадратним вирізом, який красиво підкреслює лінію плечей та шиї.",
        "Вільна спідниця м’яко рухається під час ходи, створюючи легкий та романтичний силует.",
        "Завдяки мінімалістичному дизайну сукня легко стилізується як у casual-образах, так і в більш жіночних літніх поєднаннях.",
        "Сукня ідеально пасує для прогулянок, відпочинку, подорожей та теплих вечорів, коли хочеться поєднати комфорт і витонченість.",
        "Тканина: натуральна прошва.",
        "Сезон: весна, літо."
      ],
      colors: ["бежевий"]
    },
    RU: {
      ...
      name: "Платье «Bella»",
      description: [
        "Платье «Bella» — утонченная модель из натуральной прошвы, созданная для легких и женственных летних образов.",
        "Лаконичный силуэт, деликатная фактура ткани и мягкая посадка делают его универсальным для города, отдыха и особых моментов.",
        "Модель имеет аккуратный приталенный верх с квадратным вырезом, который красиво подчеркивает линию плеч и шеи.",
        "Свободная юбка мягко движется при ходьбе, создавая легкий и романтичный силуэт.",
        "Благодаря минималистичному дизайну платье легко стилизуется как в casual-образах, так и в более женственных летних сочетаниях.",
        "Платье идеально подходит для прогулок, отдыха, путешествий и теплых вечеров, когда хочется сочетать комфорт и утонченность.",
        "Ткань: натуральная прошва.",
        "Сезон: весна, лето."
      ],
      colors: ["бежевый"]
    }
...
sku: "99439",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Linen mini/1.webp",
  images: [
    "/Dress/Linen mini/2.webp",
    "/Dress/Linen mini/3.webp",
    "/Dress/Linen mini/4.webp",
    "/Dress/Linen mini/5.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      description: [
        "The Linen mini dress is a laconic model made from 100% natural linen, created for light summer looks.",
        "Its relaxed silhouette, soft pleats, and minimalist design make it a versatile base for the city, vacations, and travel.",
        "The model features a relaxed A-line silhouette with soft vertical pleats that create fluid movement and visually elongate the figure.",
        "The high collar adds a modern accent, while the minimalist cut makes the dress easy to style in different ways.",
        "It pairs easily with sandals or open-toe shoes, as well as statement boots and accessories for a more styled look.",
        "Fabric: 100% linen.",
        "Season: spring, summer."
      ],
      colors: ["beige"]
    ...
    FR: {
      category: "Robes",
      name: "Robe Linen mini",
      description: [
        "La robe Linen mini est un modèle laconique en lin 100% naturel, créé pour des looks d’été légers.",
        "Sa silhouette ample, ses plis souples et son design minimaliste en font une base polyvalente pour la ville, les vacances et les voyages.",
        "Le modèle présente une coupe A ample avec de doux plis verticaux qui créent un mouvement fluide du tissu et allongent visuellement la silhouette.",
        "Le col montant apporte un accent moderne, tandis que la coupe minimaliste rend la robe facile à styliser de différentes façons.",
        "Elle se porte facilement avec des sandales ou des nu-pieds, mais aussi avec des bottes et accessoires plus affirmés pour un look plus travaillé.",
        "Tissu : 100% lin.",
        "Saison : printemps, été."
      ],
      colors: ["beige"]
    ...
    UA: {
      category: "Сукні",
      name: "Сукня «Linen mini»",
      description: [
        "Сукня «Linen mini» — лаконічна модель із 100% натурального льону, створена для легких літніх образів.",
        "Вільний силует, м’які складки та мінімалістичний дизайн роблять її універсальною базою для міста, відпочинку чи подорожей.",
        "Модель має вільний А-силует із м’якими вертикальними складками, що створюють плавний рух тканини та візуально витягують силует.",
        "Високий комір додає образу сучасного акценту, а мінімалістичний крій робить сукню універсальною для різних стилізацій.",
        "Сукня легко поєднується як із сандалями чи босоніжками, так і з акцентними чоботами та аксесуарами для більш стилізованого образу.",
        "Тканина: 100% льон.",
        "Сезон: весна, літо."
      ],
      colors: ["бежевий"]
    ...
    RU: {
      category: "Платья",
      name: "Платье «Linen mini»",
      description: [
        "Платье «Linen mini» — лаконичная модель из 100% натурального льна, созданная для легких летних образов.",
        "Свободный силуэт, мягкие складки и минималистичный дизайн делают его универсальной базой для города, отдыха и путешествий.",
        "Модель имеет свободный А-силуэт с мягкими вертикальными складками, которые создают плавное движение ткани и визуально вытягивают силуэт.",
        "Высокий воротник добавляет образу современный акцент, а минималистичный крой делает платье универсальным для разных стилизаций.",
        "Платье легко сочетается как с сандалиями или босоножками, так и с акцентными сапогами и аксессуарами для более стилизованного образа.",
        "Ткань: 100% лен.",
        "Сезон: весна, лето."
      ],
      colors: ["бежевый"]
...
sku: "99438",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Elza Dress/1.webp",
  images: [
    "/Dress/Elza Dress/2.webp",
    "/Dress/Elza Dress/3.webp",
    "/Dress/Elza Dress/4.webp",
    "/Dress/Elza Dress/5.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Elza Dress",
      description: [
        "The Elza dress is a delicate summer look made from natural two-layer muslin, created for lightness and femininity.",
        "The airy silhouette, delicate sleeves, and textured details add a romantic mood and effortless elegance to the model.",
        "The dress features a refined fitted silhouette with a waist accent, a square neckline, and voluminous sleeves that create a gentle and feminine look.",
        "Decorative textured inserts and horizontal elements at the hem give the piece a special character and delicate romance.",
        "The dress pairs easily with minimalist sandals or statement accessories for summer walks, vacations, and special occasions.",
        "Fabric: natural two-layer muslin.",
        "Season: spring, summer."
      ],
      colors: ["milk white"]
    ...
    FR: {
      ...
      name: "Robe Elza",
      description: [
        "La robe Elza est une silhouette estivale douce en mousseline naturelle double couche, pensée pour la légèreté et la féminité.",
        "La silhouette aérienne, les manches délicates et les détails texturés apportent une note romantique et une élégance effortless au modèle.",
        "La robe présente une coupe ajustée raffinée avec un accent sur la taille, une encolure carrée et des manches volumineuses qui créent une allure douce et féminine.",
        "Les empiècements texturés décoratifs et les éléments horizontaux au bas de la robe donnent à la pièce un caractère particulier et une romance délicate.",
        "Elle se porte facilement avec des sandales minimalistes ou des accessoires marqués pour les promenades estivales, les vacances et les occasions spéciales.",
        "Tissu : mousseline naturelle double couche.",
        "Saison : printemps, été."
      ],
      colors: ["blanc lait"]
    ...
    UA: {
      ...
      name: "Сукня «Elza»",
      description: [
        "Сукня «Elza» — ніжний літній образ із натурального двошарового мусліну, створений для легкості та жіночності.",
        "Повітряний силует, делікатні рукави та фактурні деталі додають моделі романтичного настрою та effortless elegance.",
        "Модель має витончений приталений силует із акцентом на талії, квадратний виріз та об’ємні рукави, що створюють ніжний і жіночний образ.",
        "Декоративні фактурні вставки та горизонтальні елементи внизу сукні додають виробу особливого характеру та делікатної романтики.",
        "Сукня легко поєднується як із мінімалістичними босоніжками, так і з акцентними аксесуарами для літніх прогулянок, відпочинку чи особливих подій.",
        "Тканина: натуральний двошаровий муслін.",
        "Сезон: весна, літо."
      ],
      colors: ["молочний"]
    ...
    RU: {
      ...
      name: "Платье «Elza»",
      description: [
        "Платье «Elza» — нежный летний образ из натурального двухслойного муслина, созданный для легкости и женственности.",
        "Воздушный силуэт, деликатные рукава и фактурные детали добавляют модели романтичного настроения и effortless elegance.",
        "Модель имеет изящный приталенный силуэт с акцентом на талии, квадратный вырез и объемные рукава, которые создают нежный и женственный образ.",
        "Декоративные фактурные вставки и горизонтальные элементы внизу платья придают изделию особый характер и деликатную романтику.",
        "Платье легко сочетается как с минималистичными босоножками, так и с акцентными аксессуарами для летних прогулок, отдыха и особых событий.",
        "Ткань: натуральный двухслойный муслин.",
        "Сезон: весна, лето."
      ],
      colors: ["молочный"]
...
sku: "99437",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Jasmine Dress/1.webp",
  images: [
    "/Dress/Jasmine Dress/2.webp",
    "/Dress/Jasmine Dress/3.webp",
    "/Dress/Jasmine Dress/4.webp",
    "/Dress/Jasmine Dress/5.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
      ...
      name: "Jasmine Dress",
      description: [
        "The Jasmine dress is a delicate and romantic look made from natural two-layer muslin.",
        "The light texture of the fabric, accent tiered skirt, and lace details create a feeling of effortless femininity and summer ease.",
        "The bodice with delicate draping beautifully highlights the figure, while the relaxed tiered skirt creates soft movement as you walk.",
        "Contrasting inserts in warm natural shades add depth and a bohemian mood, and lace trim completes the look with a gentle accent.",
        "Voluminous sleeves and a comfortable fit make the model versatile for vacations, travel, summer evenings, and special warm-season moments.",
        "Fabric: natural two-layer muslin.",
        "Season: spring, summer."
      ],
      colors: ["milk white"]
    ...
    FR: {
      ...
      name: "Robe Jasmine",
      description: [
        "La robe Jasmine est une silhouette douce et romantique en mousseline naturelle double couche.",
        "La texture légère du tissu, la jupe à étages marquée et les détails en dentelle créent une sensation de féminité effortless et de légèreté estivale.",
        "Le corsage au drapé délicat souligne joliment la silhouette, tandis que la jupe ample à étages apporte un mouvement fluide à chaque pas.",
        "Les empiècements contrastés dans des tons naturels chauds ajoutent de la profondeur et une touche bohème, tandis que la finition en dentelle complète le look avec douceur.",
        "Les manches volumineuses et la coupe confortable rendent ce modèle idéal pour les vacances, les voyages, les soirées d’été et les moments particuliers de la belle saison.",
        "Tissu : mousseline naturelle double couche.",
        "Saison : printemps, été."
      ],
      colors: ["blanc lait"]
    ...
    UA: {
      ...
      name: "Сукня «Jasmine»",
      description: [
        "Сукня «Jasmine» — ніжний та романтичний образ із натурального двошарового мусліну.",
        "Легка текстура тканини, акцентна багатоярусна спідниця та мереживні деталі створюють відчуття effortless femininity та літньої легкості.",
        "Ліф із делікатною драпіровкою красиво підкреслює фігуру, а вільна багатоярусна спідниця створює легкий рух під час ходи.",
        "Контрастні вставки у теплих натуральних відтінках додають сукні глибини та богемного настрою, а мереживне оздоблення завершує образ ніжним акцентом.",
        "Об’ємні рукави та комфортна посадка роблять модель універсальною як для відпочинку, подорожей чи літніх вечорів, так і для особливих моментів у теплу пору року.",
        "Тканина: натуральний двошаровий муслін.",
        "Сезон: весна, літо."
      ],
      colors: ["молочний"]
    ...
    RU: {
      ...
      name: "Платье «Jasmine»",
      description: [
        "Платье «Jasmine» — нежный и романтичный образ из натурального двухслойного муслина.",
        "Легкая текстура ткани, акцентная многоярусная юбка и кружевные детали создают ощущение effortless femininity и летней легкости.",
        "Лиф с деликатной драпировкой красиво подчеркивает фигуру, а свободная многоярусная юбка создает легкое движение при ходьбе.",
        "Контрастные вставки в теплых натуральных оттенках добавляют платью глубины и богемного настроения, а кружевная отделка завершает образ нежным акцентом.",
        "Объемные рукава и комфортная посадка делают модель универсальной для отдыха, путешествий, летних вечеров и особых моментов в теплое время года.",
        "Ткань: натуральный двухслойный муслин.",
        "Сезон: весна, лето."
      ],
      colors: ["молочный"]
...
sku: "99436",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Coraline Dress/1.webp",
  images: [
    "/Dress/Coraline Dress/2.webp",
    "/Dress/Coraline Dress/3.webp",
    "/Dress/Coraline Dress/4.webp",
    "/Dress/Coraline Dress/5.webp",
    "/Dress/Coraline Dress/6.webp",
    "/Dress/Coraline Dress/7.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
...
sku: "99435",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Sirena Dress/1.webp",
  images: [
    "/Dress/Sirena Dress/2.webp",
    "/Dress/Sirena Dress/3.webp",
    "/Dress/Sirena Dress/4.webp",
    "/Dress/Sirena Dress/5.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
...
sku: "99434",
  size: "XS S M L XL",
  category: "Costumes",
  image: "/Costumes/Eco Crash Suit/1.webp",
  images: [
    "/Costumes/Eco Crash Suit/2.webp",
    "/Costumes/Eco Crash Suit/3.webp",
    "/Costumes/Eco Crash Suit/4.webp",
    "/Costumes/Eco Crash Suit/5.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
...
sku: "99433",
  size: "XS S M L XL",
  category: "Tops",
  image: "/Top/Eco Crash Top/1.webp",
  images: [
    "/Top/Eco Crash Top/2.webp",
    "/Top/Eco Crash Top/3.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
...
sku: "99432",
  size: "XS S M L XL",
  category: "Pants",
  image: "/Pants/Aladdin Pants/1.webp",
  images: [
    "/Pants/Aladdin Pants/2.webp",
    "/Pants/Aladdin Pants/3.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
...
sku: "99431",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Lagune Dress/1.webp",
  images: [
    "/Dress/Lagune Dress/2.webp",
    "/Dress/Lagune Dress/3.webp",
    "/Dress/Lagune Dress/4.webp",
    "/Dress/Lagune Dress/5.webp",
    "/Dress/Lagune Dress/6.webp",
    "/Dress/Lagune Dress/7.webp",
    "/Dress/Lagune Dress/8.webp",
    "/Dress/Lagune Dress/9.webp",
    "/Dress/Lagune Dress/10.webp",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  translations: {
    EN: {
...
sku: "99430",
  size: "XS S M L XL",
  category: "Dresses",
  image: "/Dress/Azura Dress/1.webp",
  images: [
    "/Dress/Azura Dress/2.webp",
    "/Dress/Azura Dress/3.webp",
    "/Dress/Azura Dress/4.webp",
    "/Dress/Azura Dress/5.webp",
    "/Dress/Azura Dress/6.webp",
